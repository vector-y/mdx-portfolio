...
import { Heading, Link, Text, Code, Flex, Box } from '@chakra-ui/layout'
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        {/* mb = margin bottom */}
        <Heading as="h1" size="2xl" mt="20" mb="2">
        ...
        <Flex flexWrap="wrap" alignItems="center" justifyContent="center" maxW="800px" mt="5">
